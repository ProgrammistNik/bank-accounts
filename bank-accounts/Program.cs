...
Log.Information("Запуск приложения");
    ...
    var rabbitConnectionString = $"amqp://{rabbitConfig["UserName"]}:{rabbitConfig["Password"]}@{rabbitConfig["HostName"]}:{rabbitConfig["Port"]}";
    ...
    RecurringJob.AddOrUpdate<OutboxPublisher>(
        "publish-outbox-messages",
        publisher => publisher.PublishPendingAsync(),
        Cron.Minutely);
