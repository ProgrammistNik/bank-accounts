...
namespace bank_accounts.Migrations
{
    ...
    [Migration("20250815151323_UpdateInboxAndInboxDeadLetter")]
    partial class UpdateInboxAndInboxDeadLetter
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("bank_accounts.RabbitMQ.Models.Inbox", b =>
                {
                    ...
                    b.OwnsOne("bank_accounts.RabbitMQ.Models.ClientStatusChanged", "Payload", b1 =>
                        {
                            b1.Property<Guid>("InboxId")
                                .HasColumnType("uuid");
